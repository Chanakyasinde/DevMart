...
const categories = [
    { name: 'Code Templates', icon: Code2, color: 'from-blue-500 to-blue-600', desc: 'MERN boilerplates, auth systems, dashboards' },
    { name: 'UI Kits', icon: Palette, color: 'from-pink-500 to-pink-600', desc: 'React components, Tailwind templates' },
    { name: 'APIs & Microservices', icon: Plug, color: 'from-green-500 to-green-600', desc: 'Auth APIs, payment wrappers' },
    { name: 'AI & ML Starter Kits', icon: Bot, color: 'from-purple-500 to-purple-600', desc: 'Chatbots, recommendation engines' },
    { name: 'Developer Tools', icon: Wrench, color: 'from-orange-500 to-orange-600', desc: 'Automation scripts, DevOps configs' },
];
    ...
    return (
        <div className="min-h-screen">
            <section className="relative overflow-hidden">
                ...
                <div className="absolute top-40 right-1/4 w-96 h-96 bg-accent-500/8 rounded-full blur-[150px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                        {categories.map((cat, i) => (
                            ...
                            >
                                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${cat.color} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                                    <cat.icon className="w-7 h-7 text-white" />
                                </div>
                                <h3 className="text-sm font-semibold text-white mb-1">{cat.name}</h3>
                                <p className="text-xs text-surface-200/40">{cat.desc}</p>
                            </Link>
                        ))}
                    </div>
                </div>
